...
| Name | Source | Version |
| ---- | ------ | ------- |
| <a name="module_cloud_oidc"></a> [cloud\_oidc](#module\_cloud\_oidc) | ../standalone-repos/terraform-tfc-cloud-oidc | n/a |
| <a name="module_notifications"></a> [notifications](#module\_notifications) | ../standalone-repos/terraform-tfc-notifications | n/a |
| <a name="module_run_tasks"></a> [run\_tasks](#module\_run\_tasks) | ../standalone-repos/terraform-tfc-run-tasks | n/a |
...
| Name | Description |
| ---- | ----------- |
| <a name="output_platform_type"></a> [platform\_type](#output\_platform\_type) | hcp or enterprise. |
| <a name="output_project_id"></a> [project\_id](#output\_project\_id) | Terraform project ID. |
| <a name="output_project_name"></a> [project\_name](#output\_project\_name) | Terraform project name. |
| <a name="output_tfc_hostname"></a> [tfc\_hostname](#output\_tfc\_hostname) | Resolved TFC/TFE hostname. |
| <a name="output_vault_app_namespace"></a> [vault\_app\_namespace](#output\_vault\_app\_namespace) | App-specific Vault namespace (null if not enabled). |
| <a name="output_vault_jwt_auth_path"></a> [vault\_jwt\_auth\_path](#output\_vault\_jwt\_auth\_path) | JWT auth mount path. |
| <a name="output_vault_namespace"></a> [vault\_namespace](#output\_vault\_namespace) | Vault namespace for auth and secrets. |
| <a name="output_vault_policy_names"></a> [vault\_policy\_names](#output\_vault\_policy\_names) | All policy names attached to workspace roles. |
| <a name="output_vault_role_names"></a> [vault\_role\_names](#output\_vault\_role\_names) | environment => Vault role name map. |
| <a name="output_vault_token_max_ttl"></a> [vault\_token\_max\_ttl](#output\_vault\_token\_max\_ttl) | Token max TTL (seconds). |
| <a name="output_vault_token_ttl"></a> [vault\_token\_ttl](#output\_vault\_token\_ttl) | Token TTL (seconds). |
| <a name="output_workspace_ids"></a> [workspace\_ids](#output\_workspace\_ids) | environment => workspace ID map. |
| <a name="output_workspace_names"></a> [workspace\_names](#output\_workspace\_names) | environment => workspace name map. |
<!-- END_TF_DOCS -->
